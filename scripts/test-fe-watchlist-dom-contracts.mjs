...
check("shared page size", /export const WATCHLIST_PAGE_SIZE = 50/.test(pagination));
check("market first paint", /export const MARKET_INITIAL_VISIBLE = 30/.test(pagination));
...
check("market pages first-paint", /firstPaintScope/.test(home) && /firstPaintScope/.test(pokemon) && /firstPaintScope/.test(onePiece));
check("watchlist stays paged", !/firstPaintScope/.test(watchlist));
...
console.log("PASS FE03 full-catalog data wiring (13 contracts)");
