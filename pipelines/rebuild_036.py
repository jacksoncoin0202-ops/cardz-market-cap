...
import rebuild_036_identity_rules as _identity_rules

_identity_rules.configure(globals())
from rebuild_036_identity_rules import (  # noqa: E402,F401
    NUMBER_SET_CODE_RE,
    OPERATOR_RULING_REASON_PREFIX,
    VARIANT_OPERATOR_RULING_SQL,
    _PC_REPRINT_ONLY_PRINTINGS,
    _PRINT_PHRASES,
    _derive_print_fields,
    _gemrate_bind_evidence,
    _gemrate_printing_sha,
    _name_agrees,
    _parallel_agrees,
...
# The identity module loads earlier because most of its rules are shared by the
# rebuild stages above. Bind this late table once it exists, before the reverify
# module imports the bracket helpers.
_identity_rules.configure(globals())
...
# have to spell out.
import rebuild_036_reverify as _reverify

_reverify.configure(globals())
from rebuild_036_reverify import (  # noqa: E402,F401
    _PC_BASE_PRINTINGS,
    _PC_SPC_METALS,
    _pc_bracket_names_our_product,
    _pc_fetch_missing_pages,
