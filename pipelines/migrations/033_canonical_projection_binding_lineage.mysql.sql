-- Current provider claims can be re-evidenced without changing the physical
-- printing.  Canonical acceptances remain eligible when their exact provider
-- ID still matches the current strict printing tuple.
...
INSERT IGNORE INTO cardz_schema_version (version_code) VALUES ('033');
