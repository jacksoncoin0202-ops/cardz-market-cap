...
export const copy: Record<Locale, Copy> = {
  en: {
    ...
    boxProvenance: {
      ...
      steps: [
        { term: "Sold", detail: "Completed box sales captured inside Cards Marketcap tracked coverage. Lots are unitised to one box, extreme outliers are dropped, and what remains is reduced to a median." },
      ...
      updated: "Updated",
      byline: "Compiled and reviewed by the Cards Marketcap Editorial desk.",
    },
    hero: {
    ...
    labels: {
      ...
      salesHelp: "Only completed PSA 10 sales captured within Cards Marketcap tracked coverage.", change: "Change", changeShort: "Chg", asOf: "Data time",
    ...
    methodology: {
      title: "How Cards Marketcap ranks the market",
      /*
    ...
    provenance: {
      ...
      steps: [
        { term: "Reference price", detail: "Completed PSA 10 sales captured inside Cards Marketcap tracked coverage. Lots are unitised down to a single card, extreme outliers are dropped, and what remains is reduced to a median." },
    ...
    footer: "Cards Marketcap. Art market intelligence for collectible cards.",
  },
  "zh-TW": {
    ...
    boxProvenance: {
      ...
      steps: [
        { term: "成交", detail: "取自 Cards Marketcap 追蹤範圍內已完成的原盒成交：先還原單盒單價，剔除極端值，再取中位數。" },
        { term: "市場參考", detail: "成交覆蓋不足時，用該系列、語言與印刷版的市場參考價。" },
        { term: "掛牌底價", detail: "現時最低掛牌只作次要參考，不會取代成交或市場參考。缺失的數值永遠保持缺失，不會當作零。" },
      ],
      updated: "更新",
      byline: "由 Cards Marketcap Editorial 編算及覆核。",
    },
    hero: {
      eyebrow: "CARDS MARKET INDEX",
      title: "收藏卡牌的市場全景",
  ...
  title: "第 101 位起 · 持續觀察",
    ...
    labels: {
      ...
      salesHelp: "只包括 Cards Marketcap 追蹤範圍內捕捉到的 PSA 10 完成成交。", change: "升跌", changeShort: "升跌", asOf: "資料時間",
    ...
    provenance: {
      ...
      steps: [
        { term: "參考價", detail: "取自 Cards Marketcap 追蹤範圍內已完成的 PSA 10 成交：先按張數還原單價，剔除極端值，再取中位數。" },
    ...
    footer: "Cards Marketcap，收藏卡牌藝術市場情報。",
  },
  "zh-CN": {
    ...
    boxProvenance: {
      ...
      steps: [
        { term: "成交", detail: "取自 Cards Marketcap 追踪范围内已完成的原盒成交：先还原单盒单价，剔除极端值，再取中位数。" },
        { term: "市场参考", detail: "成交覆盖不足时，用该系列、语言与印刷版的市场参考价。" },
        { term: "挂牌底价", detail: "现时最低挂牌只作次要参考，不会取代成交或市场参考。缺失的数值永远保持缺失，不会当作零。" },
      ],
      updated: "更新",
      byline: "由 Cards Marketcap Editorial 编算及复核。",
    },
    hero: {
      eyebrow: "CARDS MARKET INDEX", title: "收藏卡牌的市场全景",
    ...
    labels: {
      ...
      trackedSalesShort: "成交",
      salesHelp: "只包括 Cards Marketcap 追踪范围内捕捉到的 PSA 10 完成成交。", change: "涨跌", changeShort: "涨跌", asOf: "数据时间",
    ...
    provenance: {
      ...
      steps: [
        { term: "参考价", detail: "取自 Cards Marketcap 追踪范围内已完成的 PSA 10 成交：先按张数还原单价，剔除极端值，再取中位数。" },
    ...
    footer: "Cards Marketcap，收藏卡牌艺术市场情报。",
  },
  ja: {
    ...
    boxProvenance: {
      ...
      steps: [
        { term: "成約", detail: "Cards Marketcap の追跡範囲で確認できたBOX成約から取得します。まとめ売りは1BOXあたりに換算し、極端な外れ値を除いたうえで中央値を用います。" },
      ...
      updated: "更新",
      byline: "Cards Marketcap Editorial が集計・確認しています。",
    },
    hero: {
      eyebrow: "CARDS MARKET INDEX", title: "コレクティブルカード市場を一望する",
    ...
    labels: {
      ...
      salesHelp: "Cards Marketcap の追跡範囲で確認できた PSA 10 の成約のみを含みます。", change: "変動", changeShort: "変動", asOf: "データ時刻",
    ...
    methodology: {
      title: "Cards Marketcap の市場ランキング方法",
    ...
    provenance: {
      ...
      steps: [
        { term: "参考価格", detail: "Cards Marketcap の追跡範囲で確認できた PSA 10 の成約から取得します。まとめ売りは1枚あたりに換算し、極端な外れ値を除いたうえで中央値を用います。" },
    ...
    footer: "Cards Marketcap。コレクティブルカードのアート市場情報。",
  },
  ko: {
    ...
    boxProvenance: {
      ...
      steps: [
        { term: "체결", detail: "Cards Marketcap 추적 범위에서 확인된 BOX 완료 거래에서 가져옵니다. 묶음은 박스 하나로 환산하고 극단값을 제거한 뒤 중앙값을 사용합니다." },
      ...
      updated: "업데이트",
      byline: "Cards Marketcap Editorial이 집계하고 검토합니다.",
    },
    hero: {
      eyebrow: "CARDS MARKET INDEX",
    ...
    labels: {
      ...
      salesHelp: "Cards Marketcap 추적 범위에서 확인된 PSA 10 완료 거래만 포함합니다.", change: "등락", changeShort: "등락", asOf: "데이터 시각",
    ...
    methodology: {
      title: "Cards Marketcap의 시장 순위 방식",
    ...
    provenance: {
      ...
      steps: [
        { term: "기준가", detail: "Cards Marketcap 추적 범위에서 확인된 PSA 10 완료 거래에서 가져옵니다. 묶음 거래는 카드 한 장 기준으로 환산하고 극단값을 제거한 뒤 중앙값을 사용합니다." },
    ...
    footer: "Cards Marketcap. 컬렉터블 카드 아트 마켓 인텔리전스.",
  },
};
