...
export const geoCopy: Record<Locale, GeoCopy> = {
  ...
  ja: {
    ...
    viewSet: "セットを見る",
    cardFact: "{name}（{set} #{num}）の PSA10 時価総額は CardZ Marketcap で {date} 時点 {cap}。PSA10 価格 {price} × PSA10 鑑定枚数 {pop} で算出。",
    cardFactRank: "{tcg}カード {total} 枚中、時価総額 {rank} 位。",
    cardFactRankNoTotal: "時価総額 {rank} 位。",
    boxTitle: "ポケカ・ワンピBOX相場 — 未開封BOX価格トラッカー",
    boxDescription: "ポケカとワンピースカードの未開封BOX相場。参考価格は成約優先で算出。{date} 時点で {total} BOX 中 {priced} BOX に価格。",
    boxFact: "CardZ Marketcap はポケモンカードとワンピースカードゲームの未開封BOX相場を追跡します。参考価格は成約価格が基準で、成約がない場合のみ最安提示価格を代用します。{date} 時点で {total} BOX 中 {priced} BOX に価格があります。",
    boxDisambiguation: "CardZ Marketcap は鑑定済みトレカと未開封BOXのデータ指数です。暗号資産・トークン・上場企業ではなく、CardZ のティッカーは存在しません。",
    boxDetailTitle: "{name} BOX相場・未開封BOX価格",
    boxDetailDescription: "{name} 未開封BOX：CardZ Marketcap の参考価格は {date} 時点で {price}。成約価格が基準で、提示価格が成約価格を代替することはありません。",
    boxDetailDescriptionNoPrice: "{name} 未開封BOX：CardZ Marketcap にまだ参考価格がありません。価格は成約優先で算出し、提示価格が成約価格を代替することはありません。",
    boxDetailFact: "{name} の未開封BOXの参考価格は CardZ Marketcap で {date} 時点 {price}（{priceKind}）。この数字は成約価格が基準で、成約がない場合のみ最安提示価格を代用します。",
    boxDetailFactNoPrice: "{name} の未開封BOXは CardZ Marketcap が追跡していますが、{date} 時点で参考価格はありません。追跡期間内に成約がないためで、欠測をゼロで埋めることはしません。",
  },
  ko: {
