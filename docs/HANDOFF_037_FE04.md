...
>
> **2026-08-16：** FE05（純 `apps/web` 升級）之後要退返呢版 FE04 → 錨點 tag `fe04-live` = `4bed89a7`，一句 `pwsh -NoProfile -File scripts\fe05_rollback.ps1`。見 [FE05_ROLLBACK.md](FE05_ROLLBACK.md)。
