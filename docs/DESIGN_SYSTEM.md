...
CARDZ uses a cold-gallery editorial system: white and near-black structure, soft neutral fields, restrained CARDZ orange, and semantic market tints. It should feel like an art index with credible market evidence, not a generic finance dashboard or a card-shop catalog.
...
- Brand accent: CARDZ orange, used sparingly for active brand moments.
...
Supported locales: English, Traditional Chinese, Simplified Chinese, Japanese.

Supported currencies: USD, HKD, CNY, GBP, TWD.
